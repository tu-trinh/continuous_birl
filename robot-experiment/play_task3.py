...
"""
home positions: ./collab/return_home 0.841334 1.16946 0.138284 -1.15176 -1.4545 1.33055 -0.00023852
"""
HOME = np.asarray([0.841334, 1.16946, 0.138284, -1.15176, -1.4545, 1.33055, -0.00023852])
...
def main():
    ...
    optimals = pickle.load( open( "choices_task3/optimal.pkl", "rb" ) )
