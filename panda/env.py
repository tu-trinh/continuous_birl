...
class Task():
    ...
    def __init__(self):
        ...
        obj1.load()
        p.resetBasePositionAndOrientation(obj1.body_id, [0.5, 0.0, 0.05], [0, 0, 0, 1])

        # target
        obj2 = YCBObject('002_master_chef_can')
        obj2.load()
        p.resetBasePositionAndOrientation(obj2.body_id, [0.75, 0.0, 0.01], [0, 0, 0, 1])
    ...
    def _set_camera(self):
        ...
        p.resetDebugVisualizerCamera(cameraDistance=1.2, cameraYaw=30, cameraPitch=-90,
